...
6. Evaluation & iterate
 ...
 Note: proposals previously captured in standalone appendices have been integrated into the canonical specs (see `spec01`, `spec03`, `spec04`, `spec05`, and `validation_decision_pseudocode.md`). Pilots and implementation should use the canonical specs under `spec00`..`spec08` as the main implementation-spec.
